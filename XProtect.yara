...
rule XProtect_MACOS_9bdf6ec
{
    strings:
        ...
        $a3 = { 67 65 74 53 74 61 74 65 4f 66 53 61 66 61 72 69 45 78 74 65 6e 73 69 6f 6e 57 69 74 68 49 64 65 6e 74 69 66 69 65 72 3a 63 6f 6d 70 6c 65 74 69 6f 6e 48 61 6e 64 6c 65 72 3a }
        $a4 = { 6d 61 63 62 75 69 6c 64 65 72 5f 62 75 69 6c 64 73 }
        $a5 = { 4c 6f 63 61 6c 53 61 66 61 72 69 41 70 70 45 78 74 }
