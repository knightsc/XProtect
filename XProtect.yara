...
{ 
    ...
    strings:
        $a = { 23 21 }
        $b1 = { 6f 70 65 6e 73 73 6c 20 65 6e 63 }
        $b2 = { 2d 61 65 73 2d 32 35 36 2d 63 62 63 }
        $c1 = { 2d 62 61 73 65 36 34 }
        $c2 = { 2d 61 }
        $d = { 2d 64 }
        $e1 = { 2d 69 6e }
        $e2 = { 2d 6e 6f 73 61 6c 74 }
        $e3 = { 2d 73 61 6c 74 }
        $e4 = { 2d 6b }
        $e5 = { 2d 6f 75 74 }
        $e6 = { 2d 70 61 73 73 }
        $f1 = { 64 64 20 69 66 3d 2f 64 65 76 2f 75 72 61 6e 64 6f 6d 20 62 73 3d 24 28 6a 6f 74 20 2d 72 20 31 20 35 20 31 35 29 }
        $f2 = { 62 61 73 65 36 34 20 7c 20 74 72 20 2d 64 63 20 27 61 2d 7a 41 2d 5a 30 2d 39 27 }
        $f3 = { 3c 65 6e 63 29 22 }
        $f4 = { 52 65 73 6f 75 72 63 65 73 2f 65 6e 63 29 22 }
        $f5 = { 73 68 65 6c 6c 5f 65 78 65 63 }
        $f6 = { 65 76 61 6c }
    condition:
      $a at 0 and filesize < 3KB and all of ($b*) and any of ($c*) and $d and any of ($e*) and any of ($f*)
}
...
rule XProtect_MACOS_e79dc35
{
    ...
    condition:
        Macho and (filesize < 300KB) and ($a or any of ($b*)) and (3 of ($c*))
}
...
{ 
    ...
    strings:
        ...
        $a6 = { 45 85 ed 41 8d 4d ff ba ?? ?? ?? ?? 0f 4e ca 42 8a 5c 25 b0 49 ff c4 49 89 c6 41 89 cd }
