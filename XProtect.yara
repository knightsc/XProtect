...
rule XProtect_MACOS_8032420
{
    ...
    strings:
        $a = { 0f 28 ?? ?? ?? ?? ?? 0f 28 ?? ?? ?? ?? ?? 0f 57 c8 0f 29 ?? ?? ?? ?? ?? 0f 57 05 e3 13 07 00 0f 29 ?? ?? ?? ?? ?? 80 35 ?? ?? ?? 00 ?? 80 35 ?? ?? ?? 00 ?? 80 35 ?? ?? ?? 00 ?? 80 35 ?? ?? ?? 00 ?? 80 35 ?? ?? ?? 00 ?? }
        $b = { 48 8d [5] 80 34 08 ?? 48 ff c0 48 ?? ?? ?? 75 ?? 48 8d [5] 48 89 df 4c 89 fe ff }
    condition:
...
{ 
    ...
    strings:
        $a1 = { 66 89 45 d2 48 ?? ?? ?? ?? ?? ?? ba 01 00 00 00 4? 89 ?e 41 ff d6 66 89 45 d4 48 ?? ?? ?? ?? ?? ?? ba 02 00 00 00 4? 89 ?e 41 ff d6 66 89 45 d6 }
...
rule XProtect_MACOS_e79dc35
{
    ...
    condition:
        Macho and (filesize < 300KB) and ($a or any of ($b*)) and (2 of ($c*))
}
...
rule XProtect_MACOS_61ee022
{
    ...
    strings:
        ...
        $s7 = { 2F 56 6F 6C 75 6D 65 73 2F 57 6F 72 6B 2F 57 6F 72 6B 2F 43 6F 64 69 6E 67 2F 43 72 79 70 74 6F 69 73 74 69 63 2F 43 72 79 70 74 6F 69 73 74 69 63 2F 4D 61 69 6E 43 6F 6E 74 72 6F 6C 6C 65 72 2E 73 77 69 66 74 }
        $s8 = { 2F 56 6F 6C 75 6D 65 73 2F 57 6F 72 6B 2F 57 6F 72 6B 2F 43 6F 64 69 6E 67 2F 43 72 79 70 74 6F 69 73 74 69 63 2F 43 72 79 70 74 6F 69 73 74 69 63 2F 53 69 67 6E 75 70 43 6F 6E 74 72 6F 6C 6C 65 72 2E 73 77 69 66 74 }
        $s9 = { 2F 56 6F 6C 75 6D 65 73 2F 57 6F 72 6B 2F 57 6F 72 6B 2F 43 6F 64 69 6E 67 2F 43 72 79 70 74 6F 69 73 74 69 63 2F 43 72 79 70 74 6F 69 73 74 69 63 2F 4C 6F 67 69 6E 43 6F 6E 74 72 6F 6C 6C 65 72 2E 73 77 69 66 74 }
        $s10 = { 45 6D 61 69 6C 20 69 73 20 69 6E 76 61 6C 69 64 61 74 65 2E }
        $s11 = { 50 61 73 73 77 6F 72 64 20 69 73 20 69 6E 63 6F 72 72 65 63 74 2E }
        $s12 = { 50 6C 65 61 73 65 20 69 6E 70 75 74 20 63 6F 6E 66 69 72 6D 20 70 61 73 73 77 6F 72 64 2E }
        $s13 = { 50 6C 65 61 73 65 20 69 6E 70 75 74 20 70 61 73 73 77 6F 72 64 2E }
        $s14 = { 53 75 63 63 65 73 73 66 75 6C 6C 79 20 63 72 65 61 74 65 64 20 61 20 6E 65 77 20 61 63 63 6F 75 6E 74 2E }
        $s15 = { 54 68 69 73 20 61 63 63 6F 75 6E 74 20 61 6C 72 65 61 64 79 20 65 78 69 73 74 73 2E }
        $s16 = { 50 61 73 73 77 6F 72 64 20 69 73 20 77 72 6F 6E 67 2E }
        $s17 = { 55 73 65 72 20 64 6F 65 73 20 6E 6F 74 20 65 78 69 73 74 21 }
    condition:
